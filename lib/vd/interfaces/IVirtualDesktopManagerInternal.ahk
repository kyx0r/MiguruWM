...
class IVirtualDesktopManagerInternal_26100 extends IUnknown {
    static GUID    := "{53F5CA0B-158F-4124-900C-057158060B27}"
    static Methods := [
        "GetCount",           ; Proc3: [out] int*
        "MoveViewToDesktop",  ; Proc4: [in] IApplicationView*, [in] desktop*
        "CanViewMoveDesktops", ; Proc5: [in] IApplicationView*, [out] int*
        "GetCurrentDesktop",  ; Proc6: [out] desktop**
        "GetDesktops",        ; Proc7: [out] IObjectArray**
        "GetAdjacentDesktop", ; Proc8: [in] desktop*, [in] int, [out] desktop**
        "SwitchDesktop",      ; Proc9: [in] desktop*
        "Proc10",            ; [in] desktop*
        "CreateDesktop",      ; Proc11: [out] desktop**
        "Proc12",            ; [in] desktop*, [in] int
        "RemoveDesktop",      ; Proc13: [in] desktop*, [in] desktop*
        "FindDesktop",        ; Proc14: [in] GUID*, [out] desktop**
        "Proc15",            ; [in] desktop*, [out] IObjectArray**, [out] IObjectArray**
        "Proc16",            ; [in] desktop*, [in] FC_USER_MARSHAL*
        "Proc17",            ; [in] desktop*, [in] FC_USER_MARSHAL*
        "Proc18",            ; [in] FC_USER_MARSHAL*
        "Proc19",            ; [in] IApplicationView*, [in] IApplicationView*
        "Proc20",            ; [in] FC_USER_MARSHAL*, [out] desktop**
        "Proc21",            ; [in] desktop*, [in] short
        "Proc22",            ; [in] desktop*
        "Proc23",            ; [out] desktop**
        "Proc24",            ; void
    ]
